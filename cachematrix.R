...
### get function like the example gets the matrix 'x'
### set function is used to change the function... when matrix is different the (inv)inverse
...
# the inverse and prints the inverse
